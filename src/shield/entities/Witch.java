...
//		if (Assets.f == 1)
			animation.setDelay(800); //715
//		else if (Assets.f == 2)
//			animation.setDelay(700); //800 is a tiny bit faster, so try >800
//		else if (Assets.f == 3)
//			animation.setDelay(1100);
...
//				else if (Assets.f == 2)
//					mb.setPosition(x, y + 10);
//				else if (Assets.f == 3)
//					mb.setPosition(x, y + 20); this shud be y + 5 
				magicBalls.add(mb);
