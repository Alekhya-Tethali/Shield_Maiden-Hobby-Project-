...
public class Level3State extends state {
	...
	private void populatebossEnemies() {
		...
		Witch w;
		Point[] wpoints = new Point[] { new Point(5550, 245), new Point(6100, 600), new Point(6600, 400),
				new Point(7200, 130), new Point(8100, 340), new Point(7500, 580), new Point(11800, 595),
				new Point(13200, 295),
	...
	private void populateCoins() {
		...
		Point[] cpoints = new Point[] { new Point(700, 500), new Point(775, 500), new Point(850, 500),
				...
				new Point(13150, 250), new Point(13200, 250), new Point(13100, 250), new Point(13150, 250),
				new Point(13050, 250), new Point(13000, 250), new Point(12900, 250), new Point(12950, 250),
				new Point(13350, 200), new Point(13300, 200), new Point(13250, 200), new Point(13200, 200), };
	...
	public void tick() {
		...
		if (player.getx() < 13500 && player.getx() > 13300 && player.gety() > 260 && player.gety() < 350
				&& player.getKeyCollection() == 3) {

			sfx.get("level").play(player);
