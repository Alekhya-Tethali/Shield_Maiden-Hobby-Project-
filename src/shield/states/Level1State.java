...
public class Level1State extends state {
	...
	public void init() {
		...
		hud = new HUD(player);
		bgMusic = new AudioPlayer("/textures/Frantic-Gameplay.mp3");
		AudioPlayer.p = 1;
		bgMusic.play(player);
		AudioPlayer.p = 0;
	...
	private void populateEnemies() {
		...
		Point[] points = new Point[] { new Point(900, 600), new Point(1300, 600), new Point(3400, 600),
				new Point(12900, 610), new Point(13200, 610), new Point(4300, 600), new Point(5900, 550),
				new Point(5050, 610), new Point(4950, 610), new Point(7200, 610), new Point(7600, 610) };
	...
	private void populatebossEnemies() {
		...
		Witch w;
		Point[] wpoints = new Point[] { new Point(10140, 630), new Point(13300, 550), new Point(8400, 370),
				new Point(6100, 560), new Point(3920, 280)
	...
	private void populateCoins() {
		...
		Point[] cpoints = new Point[] { new Point(700, 500), new Point(750, 500), new Point(800, 500),
				...
				new Point(13250, 620), new Point(13300, 530), new Point(13350, 530), new Point(7830, 450),
				new Point(7480, 450), new Point(7430, 450), new Point(7530, 450), new Point(7580, 450),
				new Point(7380, 450), new Point(7330, 450), new Point(8330, 450), new Point(8380, 450),
				new Point(8430, 450), new Point(8930, 450), new Point(8980, 450), new Point(9030, 450),
				new Point(8880, 450), new Point(9380, 450), new Point(9430, 450), new Point(9630, 410),
				new Point(9680, 410), new Point(9730, 410), new Point(9780, 250), new Point(9830, 250),
				new Point(9940, 280) };
	...
	public void tick() {
		keyPressed();
		player.update();
		tileMap.setPosition(display.width / 2 - player.getx(), display.height / 2 - player.gety()); // camera
																									// movement
																									// -
																									// player
																									// to
	...
	public void keyPressed() {
		...
		if (Game.getKeyManager().down && !Game.getKeyManager().space)
			player.setFiring();
