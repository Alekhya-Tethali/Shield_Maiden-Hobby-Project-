...
public class Level2State extends state {
	...
	private void populatebossEnemies() {
		...
		Witch w;
		Point[] wpoints = new Point[] { new Point(2200, 625), new Point(4450, 290), new Point(5250, 265),
				new Point(5800, 625), new Point(6600, 285), new Point(8675, 625), new Point(11000, 415),
				new Point(13200, 355),
	...
	private void populateHeart() {
		...
		Heart h;
		Point[] hpoints = new Point[] { new Point(6825, 525), new Point(1550, 550), new Point(12000, 450), };
